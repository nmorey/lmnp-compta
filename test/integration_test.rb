...
class IntegrationTest < Minitest::Test
    ...
    def test_full_workflow
        # 1. Import Airbnb
        puts "\n--- Test: Import Airbnb ---"
        args = ["importer-airbnb", "-f", "airbnb.csv"]
        LMNPCompta::JournalCommand.new(args).execute
        ...
        LMNPCompta::JournalCommand.new(args_add_entry).execute
        ...
        # 3. Close Year (Amortize + Clôture)
        puts "\n--- Test: Close Year (Amortize + Treasury) ---"
        ...
        # This single command should generate Amortization (DOTA2025) AND Closure (CLOTURE2025)
        ...
        assert entry_amort, "Amortization entry should exist (generated by cloturer)"
        ...
        LMNPCompta::BilanCommand.new(['liasse']).execute
        ...
        # Charges: 15 + 30.50 (Airbnb) + 302.01 (Copro) = 347.51
        # Resultat avant amort: 1496 - 347.51 = 1148.49
        # Dotations: 5283.33
        # Benefice (Limite deduc): 1148.49
        # Amort deduct: 1148.49
    ...
    def test_importer_facture_unknown_invoice_output_format
        ...
        out, err = capture_io do
            LMNPCompta::JournalCommand.new(["analyser-facture", "unknown_invoice.pdf"]).execute
        end
